...
from s03_cnn.nn_mnist.mnist_best_practices import mnist_inference
from s03_cnn.nn_mnist.mnist_best_practices import mnist_train
...
def evaluate(mnist):
    with tf.Graph().as_default() as g:
        ...
        # 通过变量冲命名的方式来加载模型，这样在前向传播的过程中就不需要调用求滑动平均的函数来获取平均值了。这样就可以完全共用mnist_inference.py中定义的前向传播过程
